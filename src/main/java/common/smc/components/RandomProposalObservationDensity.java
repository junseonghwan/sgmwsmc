...
public class RandomProposalObservationDensity<F, NodeType extends GraphNode<?>> implements ObservationDensity<GenericGraphMatchingState<F, NodeType>, Object>
{
	private Command<F, NodeType> command;
	public RandomProposalObservationDensity(Command<F, NodeType> command)
	{
	...
	@Override
  public double logWeightCorrection(GenericGraphMatchingState<F, NodeType> curLatent, GenericGraphMatchingState<F, NodeType> oldLatent) {
