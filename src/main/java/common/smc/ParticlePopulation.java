...
public final class ParticlePopulation<P> implements Serializable
{
      ...
      final double logScaling)
  {
    ...
    // compute the variance of the normalization constant
    DescriptiveStatistics stat = new DescriptiveStatistics(logWeights);
    double var = stat.getVariance() * (logWeights.length - 1) / logWeights.length;
    //System.out.println("Var(Zhat): " + var);
